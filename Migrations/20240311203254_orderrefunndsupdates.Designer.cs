...
namespace dotnetbase.Migrations
{
    ...
    [Migration("20240311203254_orderrefunndsupdates")]
    partial class orderrefunndsupdates
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1e65c9a7-c2c3-4565-9df9-7b1f103a8ccb",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "19be55bf-5cdf-42a1-b6b9-0ded99b11d56",
                            Name = "Admin",
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.SubscriptionPlanBenefit", b =>
                {
                    b.HasOne("dotnetbase.Application.Models.SubscriptionPlan", "SubscriptionPlan")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_subscription_plan_benefits_subscription_plans_subscription_pl");
