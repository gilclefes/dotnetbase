...
namespace dotnetbase.Migrations
{
    ...
    [Migration("20231225104410_AuthorizeNetTracker")]
    partial class AuthorizeNetTracker
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.AuthorizeNet.AuthorizeNetCustomerProfile", b =>
                {
                    ...
                    b.Property<int?>("BankAccountPaymentProfileId")
                        .HasColumnType("int")
                        .HasColumnName("bank_account_payment_profile_id");

                    b.Property<int?>("CardPaymentProfileId")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "df16d903-1e2f-4e43-8298-01341af91ef6",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "f14678cf-c370-4e73-9854-918b95467d22",
                            Name = "Admin",
