...
namespace dotnetbase.Migrations
{
    ...
    [Migration("20240510164854_orderreconadded")]
    partial class orderreconadded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.Charge", b =>
                {
                    ...
                    b.Property<bool>("IsYaboCharge")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("is_yabo_charge");
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.CityTax", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_city_taxes");

                    b.HasIndex("CityId")
                        .HasDatabaseName("ix_city_taxes_city_id");

                    b.ToTable("city_taxes", (string)null);
                });
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.OrderRecon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("OrdecCompletionDate")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("ordec_completion_date");
                    ...
                    b.Property<string>("PartnerUserName")
                        .IsRequired()
                        .HasColumnType("longtext")
                        .HasColumnName("partner_user_name");
                    ...
                    b.Property<decimal>("YaboShare")
                        .HasColumnType("decimal(65,30)")
                        .HasColumnName("yabo_share");

                    b.HasKey("Id")
                        .HasName("pk_order_recons");

                    b.HasIndex("OrderId")
                        .HasDatabaseName("ix_order_recons_order_id");

                    b.ToTable("order_recons", (string)null);
                });

            modelBuilder.Entity("dotnetbase.Application.Models.OrderRefund", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ExtransacitonId")
                        .IsRequired()
                        .HasColumnType("longtext")
                        .HasColumnName("extransaciton_id");

                    b.Property<DateTime>("LastRetryDate")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("last_retry_date");
                    ...
                    b.Property<string>("RefundExTransactionId")
                        .HasColumnType("longtext")
                        .HasColumnName("refund_ex_transaction_id");

                    b.Property<string>("RefundReason")
                        .HasColumnType("longtext")
                        .HasColumnName("refund_reason");

                    b.Property<int>("RefundRetry")
                        .HasColumnType("int")
                        .HasColumnName("refund_retry");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_order_refunds");

                    b.HasIndex("ClientId")
                        .HasDatabaseName("ix_order_refunds_client_id");

                    b.HasIndex("OrderId")
                        .HasDatabaseName("ix_order_refunds_order_id");

                    b.ToTable("order_refunds", (string)null);
                });

            modelBuilder.Entity("dotnetbase.Application.Models.OrderRefundDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_order_refund_details");

                    b.HasIndex("OrderRefundId")
                        .HasDatabaseName("ix_order_refund_details_order_refund_id");

                    b.ToTable("order_refund_details", (string)null);
                });
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.SubscriptionPlanBenefit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_subscription_plan_benefits");

                    b.HasIndex("Benefit")
                        .HasDatabaseName("ix_subscription_plan_benefits_benefit");

                    b.HasIndex("SubscriptionId")
                        .HasDatabaseName("ix_subscription_plan_benefits_subscription_id");

                    b.ToTable("subscription_plan_benefits", (string)null);
                });
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.SubscriptionPlanChargeExemption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_subscription_plan_charge_exemptions");

                    b.HasIndex("ChargeId")
                        .HasDatabaseName("ix_subscription_plan_charge_exemptions_charge_id");

                    b.HasIndex("SubscriptionId")
                        .HasDatabaseName("ix_subscription_plan_charge_exemptions_subscription_id");

                    b.ToTable("subscription_plan_charge_exemptions", (string)null);
                });
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "9acd4f76-493d-48ea-ba8d-a8fb26c2968c",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "477ccee7-d304-4d4f-aab0-13eb54e2c369",
                            Name = "Admin",
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.Charge", b =>
                {
                    b.HasOne("dotnetbase.Application.Models.ChargeCategory", "ChargeCategory")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_charges_charge_categories_category_id");
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.CityTax", b =>
                {
                    b.HasOne("dotnetbase.Application.Models.City", "City")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_city_taxes_cities_city_id");
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.ClientSubscription", b =>
                {
                    ...
                    b.HasOne("dotnetbase.Application.Models.SubscriptionPlan", "SubscriptionPlan")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_client_subscriptions_subscription_plans_subscription_id");
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.OrderPromoCode", b =>
                {
                    ...
                    b.HasOne("dotnetbase.Application.Models.PromoCode", "PromoCode")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_order_promo_codes_promo_codes_promo_id");
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.OrderRecon", b =>
                {
                    b.HasOne("dotnetbase.Application.Models.Order", "Order")
                        .WithMany("OrderRecons")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_order_recons_orders_order_id");
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.OrderRefund", b =>
                {
                    b.HasOne("dotnetbase.Application.Models.Client", "Client")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_order_refunds_clients_client_id");
                    ...
                    b.HasOne("dotnetbase.Application.Models.Order", "Order")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_order_refunds_orders_order_id");
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.OrderRefundDetail", b =>
                {
                    b.HasOne("dotnetbase.Application.Models.OrderRefund", "OrderRefund")
                        .WithMany("OrderRefundDetails")
                        .HasForeignKey("OrderRefundId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_order_refund_details_order_refunds_order_refund_id");
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.Service", b =>
                {
                    ...
                    b.HasOne("dotnetbase.Application.Models.ServiceType", "ServiceType")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_services_service_types_type_id");
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.SubscriptionPlan", b =>
                {
                    b.HasOne("dotnetbase.Application.Models.Period", "Period")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_subscription_plans_periods_order_period_id");
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.SubscriptionPlanBenefit", b =>
                {
                    b.HasOne("dotnetbase.Application.Models.SubscriptionPlan", "SubscriptionPlan")
                        .WithMany("SubscriptionPlanBenefits")
                        .HasForeignKey("SubscriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_subscription_plan_benefits_subscription_plans_subscription_id");
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.SubscriptionPlanCharge", b =>
                {
                    ...
                    b.HasOne("dotnetbase.Application.Models.SubscriptionPlan", "SubscriptionPlan")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_subscription_plan_charges_subscription_plans_subscription_id");
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.SubscriptionPlanChargeExemption", b =>
                {
                    b.HasOne("dotnetbase.Application.Models.Charge", "Charge")
                        .WithMany("SubscriptionPlanChargeExemptions")
                        .HasForeignKey("ChargeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_subscription_plan_charge_exemptions_charges_charge_id");
                    ...
                    b.HasOne("dotnetbase.Application.Models.SubscriptionPlan", "SubscriptionPlan")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_subscription_plan_charge_exemptions_subscription_plans_subsc");
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.SubscriptionPlanPrice", b =>
                {
                    ...
                    b.HasOne("dotnetbase.Application.Models.SubscriptionPlan", "SubscriptionPlan")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_subscription_plan_prices_subscription_plans_subscription_id");
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.SubscriptionPlanService", b =>
                {
                    ...
                    b.HasOne("dotnetbase.Application.Models.SubscriptionPlan", "SubscriptionPlan")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_subscription_plan_services_subscription_plans_subscription_id");
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.Charge", b =>
                {
                    ...
                    b.Navigation("SubscriptionPlanChargeExemptions");
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.OrderRefund", b =>
                {
                    b.Navigation("OrderRefundDetails");
                });
            ...
            modelBuilder.Entity("dotnetbase.Application.Models.SubscriptionPlan", b =>
                {
                    ...
                    b.Navigation("SubscriptionPlanBenefits");
